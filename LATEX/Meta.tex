...
% ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
\newcommand{\school}{Zürcher Hochschule für angewandte Wissenschaften}
\newcommand{\titel}{Concurrent Programming in C}					% Titel des Dokumentes										|
\newcommand{\untertitel}{TCP-Fileserver}				% Untertitel des Dokumentes									|
...
\newcommand{\autorFirst}{Micha Schönenberger}								% 1. Autor													|
...
\newcommand{\erstgutachter}{Nico Schottelius}									% Erstgutachter der Arbeit									|
