...
Der Quellcode der gesammten Arbeit wurde vom Verfasser selber geschrieben. Natürlich können sich einzelne Fragmente im Internet gefunden werden, da diese in der Programmierung immer der Fall sein wird. Es wurden jedoch kein Quellcode vom Internet übernommen, sondern nur Ideen gesammelt und standardisierte Funktionen benutzt. Hier soll als Beispiel ein memcpy erwähnt werden.\\
Der einzige Ort, von dem Code kopiert wurde, ist das github Repository des Dozenten Karl Brodowsky, welcher das Modul \flqq Systemsoftware\frqq\ durchführte (siehe Quelle \cite{githubdozent}). Diese kopierten Dateien sind jedoch im Header als solche erkennbar.
