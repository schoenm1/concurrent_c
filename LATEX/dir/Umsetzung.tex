...
Der Programmcode für das Handling von CREATE ist im Listing \ref{listing:CREATE} in Anhang \ref{Asubsec:CREATE} zu finden.
...
Der Programmcode für das Handling von UPDATE ist im Listing \ref{listing:UPDATE} in Anhang \ref{Asubsec:UPDATE} zu finden.
